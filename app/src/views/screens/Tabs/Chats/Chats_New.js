      ...
      >
        ...
        >
          <View
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('VideoCallScreen', {
                // onPress={() => navigation.navigate('VideoCallScreen_test', {
                currentUser, otherUser,
                otherUserName, otherUserImage
              })}

            >
              <Icon name="video" size={responsiveFontSize(3)} color={COLORS.white} />
            </TouchableOpacity>
            <TouchableOpacity
              style={{
                alignItems: 'center',
          ...
          <View
            style={{
              flexDirection: 'row',
              justifyContent: selectedImage ? 'space-between' :
                'space-around',
              alignItems: 'center',
              alignContent: 'center',
              width: width,
          ...
          >
            ...
            >
              <ActivityIndicator
                ...
                style={{
                  marginRight: 10,
                  display: sendingImage ? 'flex' : 'none',
                  alignSelf: 'center',
              ...
              <View
                style={{
                  flexDirection: 'row',
                  alignItems: 'center',
                  marginHorizontal: selectedImage ? responsiveWidth(5) :
                    responsiveWidth(0),
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  backgroundColor: 'rgba(255, 255, 255, 0.12)',
                  borderRadius: 50,
                  display: selectedImage ? 'flex' :
                    sendingImage ? 'none' : 'none',
                }}
              >
